package eu.addicted2random.a2rclient.test.utils;
...
public class RangeTest extends TestCase {
  ...
  public void testConstructor() {
    ...
    try {
      ...
      assertEquals("Step can't be zero or less than zero (-1).", e.getMessage());
    }
    ...
    try {
      ...
      assertEquals("Step can't be zero or less than zero (0).", e.getMessage());
    }
